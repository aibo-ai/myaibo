  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-[48px] font-extrabold mb-2 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 border border-gray-50 rounded-lg">
          ...
          <div className="lg:w-full">
            ...
            <hr/>
            <ul className="list-none space-y-4 text-xl p-8">
              <li>🤖 Process Automation → eliminate manual bottlenecks</li>
              <li>💡 Data Intelligence → connect scattered insights</li>
              <li>🎯 Performance AI → amplify results without adding costs</li>
            </ul>
          </div>
        </div>
      </div>
